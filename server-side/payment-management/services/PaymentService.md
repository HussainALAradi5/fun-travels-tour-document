...
- **Business rules:** Wallet payment is atomic with the account transaction. Credit-card and PayPal completion are showcase/demo behavior and must be replaced by verified provider callbacks in production. Unsupported/asynchronous methods remain pending.
