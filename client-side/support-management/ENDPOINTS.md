...
| EP-5 | `PATCH` | `/api/user-requests/{id}/solve` | Resolve an assigned request using the authenticated user as the actor. | Request ID | `UserRequestService` | `solveRequest` |
| EP-6 | `PATCH` | `/api/user-requests/{id}/reject` | Reject an eligible request using the authenticated support actor. | Request ID | `UserRequestService` | `rejectRequest` |
